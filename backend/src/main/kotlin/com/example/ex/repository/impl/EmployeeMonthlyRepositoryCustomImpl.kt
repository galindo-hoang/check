    ...
    override fun findEmployeeByCriteriaChart(criteriaChart: CriteriaChart): List<EmployeeMonthlyChart> {
        ...
        return query.select(
            ...
            EmployeeMonthlyChart(
                ...
                yearMonth = it[employeeMonthly.date.year()]!!.toString() + "-" + it[employeeMonthly.date.month()]!!.toString()
            )
        }
    }

    override fun getListProjectGroups(): List<String> =
        getJpaQuery(entityManager)
            .from(employeeMonthly)
            .groupBy(employeeMonthly.projectGroup)
            .having(employeeMonthly.projectGroup.isNotNull)
            .select(employeeMonthly.projectGroup)
            .fetch() as List<String>
